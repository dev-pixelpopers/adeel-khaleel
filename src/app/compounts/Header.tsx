...
export default function Header() {
  ...
  return (
    ...
    <header className="fixed top-0 left-0 w-full z-50 px-6 py-6 header opacity-0 ">
      ...
      <div className="sub-header max-w-[400px] md:max-w-[650px] lg:max-w-[1680px] mx-auto flex items-center justify-between rounded-full border border-white/20 bg-[#545454]/40 px-3 pr-6  backdrop-blur-md shadow-[0_8px_32px_rgba(0,0,0,0.18),inset_0_1px_0_rgba(255,255,255,0.15)]">
        <a href="/" className="flex items-center gap-3 shrink-0 Main-Logo">
          <div className="h-[70px] md:h-[100px] lg:h-[70px] 2xl:h-[100px] items-center justify-center xl:p-2 py-2 md:py-3 ">
            <img
              src="/logo.png"
              alt="Mohammed Khaleel MD Logo"
              className="w-full h-full object-contain"
        ...
        <div className="hidden lg:block booking">
          <a
            href="/contact"
            className="border-3 border-white bg-[#8E6C36]/90 text-white font-Matangi-Bold text-base lg:text-sm font-bold px-[20px] py-[10px] rounded-full transition-all duration-300 backdrop-blur-md shadow-[inset_0_1px_0_rgba(255,255,255,0.35),0_4px_16px_rgba(0,0,0,0.15)] inline-block hover:bg-[#8E6C36]"
          >
            Book Your Appointments
          </a>
        </div>
