  ...
  return (
    <>
      <div ref={containerRef} className="relative w-full ">
        <section
          className="relative w-full h-dvh bg-cover bg-center bg-no-repeat flex items-center justify-center py-16 px-5 sm:py-20 sm:px-8 md:px-12 text-center select-none overflow-hidden min-h-dvh  mt-[-7%]"
