...
export default function Services() {
  ...
  useGSAP(
    () => {
      ...
      // Animate through each service step
      ...
      // Smoothly slide ReclaimLifeSection up to cover the viewport on final scroll step
      if (reclaimWrapperRef.current) {
        tl.to(
  ...
  return (
    <div ref={outerContainerRef} className="relative w-full h-[550vh]">
