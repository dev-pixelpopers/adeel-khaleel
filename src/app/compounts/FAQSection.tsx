  ...
  return (
    ...
    >
      <div className="w-full mx-auto flex flex-col items-center">
        ...
        <h2
          className={`font-Adorage uppercase text-2xl 2xs:text-[28px] xs:text-[32px] sm:text-[45px] md:text-[60px] lg:text-[70px] xl:text-[82px] font-normal tracking-wide text-center leading-tight mb-12 ${
            isLight
              ? "text-[#545454]"
          ...
          {faqData.map((faq, index) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span
                    className={`font-Matangi-Medium text-sm 2xs:text-base xs:text-lg sm:text-xl md:text-[30px] lg:text-[36px] font-normal tracking-wide pr-4 ${
                  ...
                  >
                    {faq.question}
                        ...
                        <svg
                            className={`w-3 h-3 xs:w-5 xs:h-5 sm:w-8 sm:h-8 md:w-10 md:h-10 transition-transform duration-300 ease-in-out shrink-0 ${isLight ? "text-[#8E6C36]" : "text-white"} ${isOpen ? "rotate-180" : "rotate-0"
                                }`}
                ...
                >
                  <div className="overflow-hidden">
                    <p
                      className={`font-Matangi-Regular text-sm 2xs:text-base md:text-xl lg:text-[28px] font-light leading-relaxed pr-4 xs:pr-8 ${
